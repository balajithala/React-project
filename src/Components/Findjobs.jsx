...
const Filter = () => {
    ...
    // 
    // const handleVisibilityChange = (event) => setIsVisible(event.target.checked);
    ...
    const PrimaryradiojobCards = [
        {
            id: 13, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/1-6.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-1.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const SecondaryradiojobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-2.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-3.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const CustomradiojobCards = [
        {
            id: 16, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-5.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 17, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-6.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const DefaultradiojobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/6-1.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/6-2.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const FreshyearjobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/6-3.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/6-4.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const FirstyearjobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/6-5.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-8.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const SecondyearjobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/1-2.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/1-3.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const ThirdyearjobCards = [
        ...
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/1-6.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    const FourthyearjobCards = [
        {
            id: 14, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-5.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']

        },
        {
            id: 15, title: 'Software Engineer (Android), Freelancer', imageSrc: '/brandimages/2-6.webp', location: 'London, UK', timeAgo: '11 hours ago', salary: '$35k-$45k', badges: ['Part-time', 'Private', 'Urgent']
    ...
    return (
        <div className="find-job">
                ...
                <Offcanvas show={show} onHide={handleClose}>
                    ...
                    <Offcanvas.Body>
                        ...
                        <div class="custom-control custom-radio">
                            <input id="customRadio" className="custom-radio-input" type="radio" checked={isAllChecked} onClick={AllcheckboxChange} name='custom-primary-radio'
                            />
                        ...
                        <div class="custom-control custom-radio">
                            <input id="customRadio" className="custom-radio-input" type="radio" checked={isLasthourChecked} onClick={LasthourcheckboxChange} name='custom-primary-radio'
                            />
                            <label className="custom-control-label" For="formRadioDefault">
                                LastHour
                            </label>
            ...
            <Container>
                <Row>
                <div class="card flex-row" style={{ backgroundColor: "#f3f7fb", borderStyle: "none",marginTop:"30px" }}>
                    <div class="card-body">
                        <h2 class="card-title h2">Recruiting?
                        </h2>
                        <Col lg={6}>
                            <p class="card-text">Advertise your jobs to millions of monthly users and search 15.8 million
                                CVs in our database.</p></Col>
                        <button type="button" className='req-button'>start recuriting Now</button>
                    </div>
                    <Col lg={6}>
                        <img class="float-right" src="/hiringimage/hire-image-2.jpg" /></Col>
                </div>
                </Row>
            </Container >
            <div>
